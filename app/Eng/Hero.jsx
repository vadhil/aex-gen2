...
export default function Hero() {
  return (
    ...
    h-screen text-white">
      ...
      md:text-xl font-medium capitalize
      ">Reach More Customer and Increase your margin right now!</motion.p>
      <motion.button 
      initial={{ opacity: 0, y: 15}}
      whileInView={{ opacity: 1, y: 0}}
      ...
      font-semibold text-primary">
        <Link href='https://wa.me/0895307455556' passHref>Chat now</Link></motion.button>
      </div>
    </section>
  )
}
